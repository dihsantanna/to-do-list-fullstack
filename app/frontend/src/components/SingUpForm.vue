...
<template>
  <form class="flex items-center flex-col gap-4 justify-between px-4 mt-24">
    ...
    <div class="flex w-full items-end justify-between">
      <button
        type="submit"
        class="bg-green-400 hover:bg-green-500 text-gray-100 font-bold py-2 px-8 rounded-md"
      >
        Cadastrar
      </button>
    </div>
